...
class AddressResource extends base_1.BaseResource {
    ...
    async getAlkanes({ address }) {
        return this.client.fetch(`/address/${address}/alkanes`);
    }
    async getAlkaneUtxos({ address }) {
        return this.client.fetch(`/address/${address}/utxos/alkanes`);
    }
}
